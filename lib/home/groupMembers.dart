...
class ViewMembersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: F_ViewMembersPage(),
    );
  }
}

class F_ViewMembersPage extends StatefulWidget {
  // F_ProfilePage({@required this.database});
  // Database database;

  @override
  _F_ViewMembersPageState createState() => _F_ViewMembersPageState();
}

class _F_ViewMembersPageState extends State<F_ViewMembersPage> {
