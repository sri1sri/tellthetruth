...
import 'custom_appbar_widget/custom_app_bar.dart';
import 'offline_widgets/offline_widget.dart';
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text("Comming Soon",style: backgroundTextStyleLight,),
                    ),
                    SizedBox(
                      width: 400.0,
                      height: 400.0,
                    ...
                    Padding(
                      padding: const EdgeInsets.all(15.0),
                      child: Text('This Feature is \nnot yet Implemented....!',style: foregroundTextStyleDark,),
                    ),
