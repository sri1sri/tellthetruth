  ...
  Widget _buildContent(BuildContext context) {
    return TransparentLoading(
      ...
      child: Scaffold(
        body: Padding(
          padding:
              const EdgeInsets.only(top: 80.0, bottom: 20, left: 15, right: 15),
            ...
            child: Column(
              ...
              children: <Widget>[
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Row(
                                      ...
                                      children: <Widget>[
                                    Container(),
                                    Text("Continue", style: subTitleDark),
                                    Icon(
                                      Icons.arrow_forward,
                                      color: Colors.white,
                                    ),
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text("Already have an account?", style: descriptionDark),
                    FlatButton(
                      child: Text(
                        'Sign In',
                        style: subTitleDark,
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => EmailAuthenticationPage(),
                          ),
                        );
                      },
                    ),
